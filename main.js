...
const isCartOpen = headerEl.querySelector("#isCartIcon");
    ...
    ${cartItems
      .map(
        ...
        <li class="flex items-center gap-3 px-3">
          <figure class="min-w-20 sm:w-[100px]">
            ...
            <table class="w-full [&_td]:p-2">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button id="addToCartBtn" data-cartid="${item.id
...
function handleView(id) {
  ...
  viewPage.innerHTML = `
    <figure class="w-[500px] flex-col justify-center">
      <div>
      ...
      <figcaption>
        <table >
          <tbody>
            ...
            <tr>
              <td>Availability: </td>
              <td>${findData.availability}</td>
            </tr>
            <tr>
              <td>Rating: </td>
              <td>${findData.rating}</td>
            </tr>
          </tbody>
        </table>
      </figcaption>
